...
INSERT INTO `kf_category_sub` VALUES (1,'基础知识',1,0),(3,'JFINAL',2,0),(4,'FUNCTION详解',1,0),(6,'javascript',3,0),(7,'css',3,0),(8,'谈谈生活',4,0),(9,'软件分享',4,2),(10,'图片展示',4,0),(11,'开发需知',1,0),(12,'代码分享',2,0),(13,'SAPJCO',1,0),(15,'ABAP',6,0),(16,'SAP',6,1);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kf_category_super` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(40) NOT NULL,
  `order` int(3) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `kf_category_super` VALUES (1,'ABAP',0),(2,'JAVA',1),(3,'WEB技术',2),(4,'@生活@',3),(6,'资料分享',4);
...
INSERT INTO `kf_project` VALUES (1,'无',0),(2,'ABAP基础',0),(3,'报表程序--选择屏幕',0),(4,'FUNCTION详解',0),(5,'ALV细说',0),(6,'ABAP关于时间',0),(7,'DNPRO细节',0),(8,'ALV控件的使用',0),(9,'资料分享',0);
